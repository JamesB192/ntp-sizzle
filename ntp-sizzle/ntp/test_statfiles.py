...
class TestPylibStatfiles(unittest.TestCase):
    ...
    def test_iso_to_posix_inverts_posix_to_iso(self):
        self.assertEqual(
            ntp.statfiles.iso_to_posix(
                ntp.statfiles.posix_to_iso(1480999786)
            ),
            1480999786,
        )
...
class TestNTPStats(unittest.TestCase):
    ...
    def test_unixize(self):
        ...
        self.assertEqual(
            f(["5 3600", "6 86399", "40587 .125"], -3600000000, 10000),
            [
        ...
        self.assertEqual(
            f(["heeeey duuuude!", "40588 0"], 0, 86401),
            [[86400000, "86400.0"]],
        )
        # Test something not in range
        self.assertEqual(
            f(
                ["40587 0", "40587 1.0625", "40587 86399", "40588 1"],
                1,
                86400,
            ),
    ...
    def test_percentiles(self):
        ...
        self.assertEqual(
            f([10, 25, 50, 90, 100], [1, 23, 42, 99]),
            {"p10": 1, "p25": 23, "p90": 99, "p50": 42, "p100": 99},
        )
    ...
    def test_ip_label(self):
        ...
        try:
            ...
            self.assertEqual(
                f("127.127.42.23"), "REFCLOCK(type=42,unit=23)"
            )
        finally:
    ...
    def test___init__(self):
        ...
        try:
            ...
            self.assertEqual(
                cls.peerstats, ["peerstats peer0", "peerstats peer1"]
            )
            self.assertEqual(
                cls.loopstats, ["loopstats loop0", "loopstats loop1"]
            )
            self.assertEqual(
                cls.rawstats, ["rawstats raw0", "rawstats raw1"]
            )
            self.assertEqual(cls.temps, ["temps temp0", "temps temp1"])
            self.assertEqual(cls.gpsd, ["gpsd gpsd0", "gpsd gpsd1"])
            # Test all arguments
            faketimemod.time_returns = [TDP * 2]
            ...
            load_returns = [[], [], [], [], [], []]
            cls = self.target(
                "/foo/bar", "Sitename", 100, starttime=150
            )
    ...
    def test___load_statfiles(self):
        ...
        try:
            ...
            self.assertEqual(
                cls._NTPStats__load_stem("/foo/bar", "temps"),
                [
                    "604801.25 40594 90\n",
                    "#blah",
                    "604802.25 40594 91",
    ...
    def test___process_stem_lines(self):
        try:
            ...
            cls = self.target(
                "/foo/bar", "sitename", starttime=0, endtime=(86400 * 7)
            )
            self.assertEqual(
                cls._NTPStats__process_stem("clockstats", dataOne),
                [
                    [5000, "5.0", "foo"],
                    [10000, "10.0", "bar"],
                    [15000, "15.0", "baz"],
            ...
            self.assertEqual(
                cls._NTPStats__process_stem("peerstats", dataOne),
                [
                    [5000, "5.0", "foo"],
                    [10000, "10.0", "bar"],
                    [15000, "15.0", "baz"],
            ...
            self.assertEqual(
                cls._NTPStats__process_stem("loopstats", dataOne),
                [
                    [5000, "5.0", "foo"],
                    [10000, "10.0", "bar"],
                    [15000, "15.0", "baz"],
            ...
            self.assertEqual(
                cls._NTPStats__process_stem("rawstats", dataOne),
                [
                    [5000, "5.0", "foo"],
                    [10000, "10.0", "bar"],
                    [15000, "15.0", "baz"],
            ...
            self.assertEqual(
                cls._NTPStats__process_stem("temps", dataTwo),
                [
                    [20500, "20.5", "5", "foo"],
                    [21500, "21.5", "10", "bar"],
                    [22500, "22.5", "15", "baz"],
            ...
            self.assertEqual(
                cls._NTPStats__process_stem("gpsd", dataTwo),
                [
                    [20500, "20.5", "5", "foo"],
                    [21500, "21.5", "10", "bar"],
                    [22500, "22.5", "15", "baz"],
