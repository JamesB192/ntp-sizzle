...
class TestNtpclientsNtpsnmpd(unittest.TestCase):
    ...
    def test_RegisterPDU(self):
        ...
        test_pducore(
            self, basicPkt_LE_new, AX.PDU_REGISTER, False, 1, 2, 3
        )
        self.assertEqual(basicPkt_LE_new.timeout, 4)
        self.assertEqual(basicPkt_LE_new.priority, 5)
        self.assertEqual(
            basicPkt_LE_new.subtree, AX.OID((1, 2, 3), False)
        )
    ...
    def test_UnregisterPDU(self):
        ...
        test_pducore(
            self, basicPkt_LE, AX.PDU_UNREGISTER, False, 1, 2, 3
        )
        self.assertEqual(basicPkt_LE.priority, 5)
        self.assertEqual(basicPkt_LE.subtree, AX.OID((1, 2, 3), False))
        self.assertEqual(basicPkt_LE.rangeSubid, 0)
        ...
        fancyPkt_new = dec(body, header)
        test_pducore(
            self, fancyPkt_new, AX.PDU_UNREGISTER, True, 1, 2, 3
        )
        self.assertEqual(fancyPkt_new.priority, 5)
        self.assertEqual(fancyPkt_new.subtree, AX.OID((1, 2, 3), False))
        self.assertEqual(fancyPkt_new.rangeSubid, 5)
    ...
    def test_GetNextPDU(self):
        ...
        fullPkt_LE_new = dec(body, header)
        test_pducore(
            self, fullPkt_LE_new, AX.PDU_GET_NEXT, False, 1, 2, 3
        )
        self.assertEqual(
            fullPkt_LE_new.oidranges,
            (
    ...
    def test_GetBulkPDU(self):
        ...
        pkt = cls(
            ...
            1,
            5,
            (srch((1, 2), (3, 4), False), srch((6, 7), (8, 9), True)),
            context="blah",
        )
    ...
    def test_TestSetPDU(self):
        ...
        pkt = cls(
            ...
            (
                AX.Varbind(
                    AX.VALUE_OID, (1, 2, 3), AX.OID((4, 5, 6), False)
                ),
        ...
        self.assertEqual(
            ...
            (
                ...
                AX.Varbind(
                    AX.VALUE_OCTET_STR, AX.OID((1, 2, 4), False), "blah"
                ),
            ),
        )
        self.assertEqual(pkt_new.context, "blah")
    ...
    def test_CommitSetPDU(self):
        ...
        pkt_LE_new = dec(body, header)
        test_pducore(
            self, pkt_LE_new, AX.PDU_COMMIT_SET, False, 1, 2, 3
        )
        # Test packetVars
        self.assertEqual(
            pkt_new.packetVars(),
    ...
    def test_CleanupSetPDU(self):
        ...
        pkt_LE_new = dec(body, header)
        test_pducore(
            self, pkt_LE_new, AX.PDU_CLEANUP_SET, False, 1, 2, 3
        )
        # Test packetVars
        self.assertEqual(
            pkt_new.packetVars(),
    ...
    def test_IndexAllocPDU(self):
        ...
        pkt_LE_new = dec(body, header)
        test_pducore(
            self, pkt_LE_new, AX.PDU_INDEX_ALLOC, False, 1, 2, 3
        )
    ...
    def test_IndexDeallocPDU(self):
        ...
        pkt_LE_new = dec(body, header)
        test_pducore(
            self, pkt_LE_new, AX.PDU_INDEX_DEALLOC, False, 1, 2, 3
        )
        self.assertEqual(pkt_LE_new.newIndex, True)
        self.assertEqual(pkt_LE_new.anyIndex, True)
        self.assertEqual(
    ...
    def test_AddAgentCapsPDU(self):
        ...
        test_pducore(
            self, pkt_LE, AX.PDU_ADD_AGENT_CAPS, False, 1, 2, 3
        )
        ...
        pkt_new = dec(body, header)
        test_pducore(
            self, pkt_new, AX.PDU_ADD_AGENT_CAPS, True, 1, 2, 3
        )
        ...
        pkt_LE_new = dec(body, header)
        test_pducore(
            self, pkt_LE_new, AX.PDU_ADD_AGENT_CAPS, False, 1, 2, 3
        )
    ...
    def test_RMAgentCapsPDU(self):
        ...
        pkt_LE_new = dec(body, header)
        test_pducore(
            self, pkt_LE_new, AX.PDU_RM_AGENT_CAPS, False, 1, 2, 3
        )
        self.assertEqual(pkt_LE_new.oid, AX.OID((4, 5, 6), False))
        self.assertEqual(pkt_LE_new.context, "bluh")
        # Test packetVars
    ...
    def test_integer32(self):
        ...
        # Decode
        self.assertEqual(
            dec(b"\x00\x00\x00\x2A" + extraData, standardFlags),
            (42, extraData),
        )
        # Decode, little endian
        self.assertEqual(
            dec(b"\x2A\x00\x00\x00" + extraData, lilEndianFlags),
            (42, extraData),
        )
    ...
    def test_nullvalue(self):
        ...
        # Decode
        self.assertEqual(
            dec(extraData, standardFlags), (None, extraData)
        )
    ...
    def test_integer64(self):
        ...
        # Encode
        self.assertEqual(
            enc(True, 42), b"\x00\x00\x00\x00\x00\x00\x00\x2A"
        )
        # Encode, little endian
        self.assertEqual(
            enc(False, 42), b"\x2A\x00\x00\x00\x00\x00\x00\x00"
        )
        # Decode
        self.assertEqual(
            dec(
                b"\x00\x00\x00\x00\x00\x00\x00\x2A" + extraData,
                standardFlags,
            ),
            (42, extraData),
        )
        ...
        self.assertEqual(
            dec(
                b"\x2A\x00\x00\x00\x00\x00\x00\x00" + extraData,
                lilEndianFlags,
            ),
            (42, extraData),
        )
    ...
    def test_ipaddr(self):
        ...
        # Encode correct
        self.assertEqual(
            enc(True, (1, 2, 3, 4)), b"\x00\x00\x00\x04\x01\x02\x03\x04"
        )
        ...
        self.assertEqual(
            dec(
                b"\x00\x00\x00\x04\x01\x02\x03\x04" + extraData,
                standardFlags,
            ),
            ((1, 2, 3, 4), extraData),
        )
        ...
        self.assertEqual(
            dec(
                b"\x04\x00\x00\x00\x01\x02\x03\x04" + extraData,
                lilEndianFlags,
            ),
            ((1, 2, 3, 4), extraData),
        )
    ...
    def test_OID(self):
        ...
        self.assertEqual(
            cls.encode(True),
            b"\x02\x00\x01\x00" b"\x00\x00\x00\x01\x00\x00\x00\x02",
        )
        # Encode together
        ...
        cls, xtr = dec(
            b"\x05\x00\x00\x00\x00\x00\x00\x01"
            b"\x00\x00\x00\x02\x00\x00\x00\x03"
        ...
        # Decode prefixed OID
        cls, xtr = dec(
            b"\x03\x17\x00\x00\x00\x00\x00\x01"
            b"\x00\x00\x00\x02\x00\x00\x00\x03",
            standardFlags,
        )
        self.assertEqual(isinstance(cls, target), True)
        ...
        # Decode include
        cls, xtr = dec(
            b"\x02\x00\x05\x00\x00\x00\x00\x01\x00\x00\x00\x02",
            standardFlags,
        )
        self.assertEqual(isinstance(cls, target), True)
        ...
        # Decode together
        cls, xtr = dec(
            b"\x04\x01\x02\x00\x00\x00\x00\x03"
    ...
    def test_searchrange(self):
        ...
        cls = target((), (), False)
        self.assertEqual(
            cls.encode(True), b"\x00\x00\x00\x00\x00\x00\x00\x00"
        )
        # Encode inclusive
        ...
        self.assertEqual(
            dec(
                b"\x00\x00\x00\x00\x00\x00\x00\x00" + extraData,
                standardFlags,
            ),
    ...
    def test_encode_searchrange_list(self):
        ...
        self.assertEqual(
            enc(
                True, (srch((1, 2), (1, 2), True), srch((2, 3), (3, 4)))
            ),
        ...
        self.assertEqual(
            enc(
                False,
                (srch((1, 2), (1, 2), True), srch((2, 3), (3, 4))),
            ),
    ...
    def test_decode_searchrange_list(self):
        ...
        self.assertEqual(
            ...
            (srch((1, 2), (1, 2), True), srch((2, 3), (3, 4), False)),
        )
        # Test, little endian
        self.assertEqual(
            dec(
    ...
    def test_xcode_octetstr(self):
        ...
        # Decode empty
        self.assertEqual(
            dec(b"\x00\x00\x00\x00", standardFlags), ("", b"")
        )
        # Decode word multiple, extra data
        self.assertEqual(
            dec(b"\x00\x00\x00\x04blah" + extraData, standardFlags),
            ("blah", extraData),
        )
        # Decode word multiple, little endian
        self.assertEqual(
            dec(b"\x04\x00\x00\x00blah", lilEndianFlags), ("blah", b"")
        )
        # Decode non word multiple, extra data
        self.assertEqual(
            dec(
                b"\x00\x00\x00\x05" b"blarg\x00\x00\x00" + extraData,
                standardFlags,
            ),
            ("blarg", extraData),
        )
    ...
    def test_Varbind(self):
        ...
        # Test oid type
        cls = target(
            AX.VALUE_OID, (1, 2, 3), AX.OID((16, 42, 256), False)
        )
        self.assertEqual(
            cls.encode(True),
    ...
    def test_decode_varbind(self):
        ...
        self.assertEqual(
            ...
            (AX.Varbind(AX.VALUE_NULL, AX.OID((1, 2, 3), False)), b""),
        )
        self.assertEqual(
            f(
                b"\x00\x80\x00\x00\x03\x00\x00\x00"
            ...
            (
                AX.Varbind(
                    AX.VALUE_NO_SUCH_OBJECT, AX.OID((1, 2, 3), False)
                ),
                b"",
            ),
        )
        self.assertEqual(
            ...
            (
                AX.Varbind(
                    AX.VALUE_NO_SUCH_INSTANCE, AX.OID((1, 2, 3), False)
                ),
                b"",
            ),
        )
        self.assertEqual(
            ...
            (
                AX.Varbind(
                    AX.VALUE_END_OF_MIB_VIEW, AX.OID((1, 2, 3), False)
                ),
                b"",
            ),
        )
        ...
        self.assertEqual(
            ...
            (
                AX.Varbind(
                    AX.VALUE_INTEGER, AX.OID((1, 2, 3), False), -42
                ),
                b"",
            ),
        )
        self.assertEqual(
            ...
            (
                AX.Varbind(
                    AX.VALUE_COUNTER32, AX.OID((1, 2, 3), False), 42
                ),
                b"",
            ),
        )
        ...
        self.assertEqual(
            ...
            (
                AX.Varbind(
                    AX.VALUE_GAUGE32, AX.OID((1, 2, 3), False), 42
                ),
                b"",
            ),
        )
        self.assertEqual(
            ...
            (
                AX.Varbind(
                    AX.VALUE_TIME_TICKS, AX.OID((1, 2, 3), False), 42
                ),
                b"",
            ),
        )
        ...
        self.assertEqual(
            ...
            (
                AX.Varbind(
                    AX.VALUE_COUNTER64, AX.OID((1, 2, 3), False), 42
                ),
                b"",
            ),
        )
        ...
        self.assertEqual(
            f(
                b"\x43\x00\x00\x00\x03\x00\x00\x00"
                b"\x01\x00\x00\x00\x02\x00\x00\x00\x03\x00\x00\x00"
                b"\x2A\x00\x00\x00",
                lilEndianFlags,
            ),
    ...
    def test_encode_flagbyte(self):
        ...
        self.assertEqual(
            f(makeflags(False, True, False, True, False)), 0x0A
        )
        self.assertEqual(
            f(makeflags(True, False, True, False, True)), 0x15
        )

    def test_decode_flagbyte(self):
        f = AX.decode_flagbyte
        self.assertEqual(
            f(0x0A), makeflags(False, True, False, True, False)
        )
        self.assertEqual(
            f(0x15), makeflags(True, False, True, False, True)
        )
    ...
    def test_decode_packet(self):
        ...
        self.assertEqual(
            ...
            (AX.ClosePDU(True, 1, 2, 3, AX.RSN_OTHER), True, b""),
        )
        # Test register
        self.assertEqual(
            f(
        ...
        self.assertEqual(
            ...
            (AX.GetNextPDU(True, 1, 2, 3, ()), True, b""),
        )
        # Test get bulk
        self.assertEqual(
            f(
        ...
        self.assertEqual(
            ...
            (AX.CommitSetPDU(True, 1, 2, 3), True, b""),
        )
        # Test undo set
        self.assertEqual(
            f(
            ...
            (AX.UndoSetPDU(True, 1, 2, 3), True, b""),
        )
        # Test cleanup set
        self.assertEqual(
            f(
            ...
            (AX.CleanupSetPDU(True, 1, 2, 3), True, b""),
        )
        # Test notify
        self.assertEqual(
            f(
        ...
        self.assertEqual(
            ...
            (
                AX.AddAgentCapsPDU(
                    True, 1, 2, 3, AX.OID((4, 5, 6), False), "blah"
                ),
                True,
                b"",
            ),
        ...
        self.assertEqual(
            ...
            (AX.ResponsePDU(True, 1, 2, 3, 4, 5, 6), True, b""),
        )
        # Test errors
        ...
        try:
            ...
            errored = e
        self.assertEqual(
            errored.message, "PDU type 255 not in defined types"
        )
    ...
    def test_bits2Bools(self):
        ...
        # Test partial bytes
        self.assertEqual(
            bits2bool("\xFF\xE1", 12),  # The extra bit is to
            [
                True,
                True,
                True,
